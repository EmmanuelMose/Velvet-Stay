...
export const registerUserController = async (req, res) => {
    try {
        ...
        await sendEmail(email, "Verify your account", `Hello ${lastName || "User"}, your verification code is: ${verificationCode}`, `<h2>Hello ${lastName || "User"},</h2><p>Your verification code is: <strong>${verificationCode}</strong></p>`);
...
export const verifyUserController = async (req, res) => {
    ...
    try {
        ...
        await sendEmail(email, "Account Verified", `Hello ${user.lastName}, your account is now verified.`, `<h2>Hello ${user.lastName},</h2><p>Your account has been <strong>successfully verified</strong>.</p>`);
