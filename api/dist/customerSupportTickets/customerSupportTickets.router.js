...
const customerSupportRoutes = (app) => {
    ...
    app.route('/tickets').get(async (req, res, next) => {
        try {
    ...
    app.route('/ticket/:id').get(async (req, res, next) => {
        try {
    ...
    app.route('/ticket/:id').put(async (req, res, next) => {
        try {
    ...
    app.route('/ticket/:id').delete(async (req, res, next) => {
        try {
